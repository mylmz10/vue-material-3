import{w as N,q as V,c as $,a as I,T as q,r,b as _,e as P,m as R,n as U,h as p,j as v,d as A,l as K,z as k}from"./iframe-BZY2mGdK.js";import{M as L}from"./MdElevationOverlay-Dhs5M7wx.js";import{_ as z}from"./_plugin-vue_export-helper-DlAUqK2U.js";import{_ as H}from"./MdFilledButton-BkjlfHw4.js";import{_ as G}from"./MdTextButton-B0fe0RDg.js";import{_ as J}from"./MdOutlinedTextField-ZAAHV9ek.js";import"./preload-helper-PPVm8Dsz.js";import"./buttonSharedProps-CQjuewrW.js";import"./MdRipple-qtXqqLlf.js";import"./MdIcon-BgVvRcVs.js";import"./MdTextFieldBase-DPgajM4b.js";import"./MdOutlinedField-B-DIdXHZ.js";import"./MdField-Uc3M5w1E.js";const Q={class:"md-modal__header"},W={class:"md-modal__content"},X={class:"md-modal__footer"},Y='a[href],button:not([disabled]),textarea:not([disabled]),input:not([disabled]),select:not([disabled]),[tabindex]:not([tabindex="-1"]),[contenteditable="true"]',Z={__name:"MdDialog",props:{modelValue:{type:Boolean,default:!1},closeOnEscape:{type:Boolean,default:!0},closeOnBackdropClick:{type:Boolean,default:!0},trapFocus:{type:Boolean,default:!0},restoreFocus:{type:Boolean,default:!0},initialFocus:{type:[String,Function],default:null}},emits:["update:modelValue","open","opened","close","closed","cancel"],setup(d,{emit:c}){let l=0;const a=r(!1),i=r(null),o=r(null),b=r(null),n=d,s=c,B=()=>{typeof document>"u"||(l+=1,l===1&&(document.body.style.overflow="hidden"))},h=()=>{typeof document>"u"||(l=Math.max(0,l-1),l===0&&(document.body.style.overflow=""))},M=()=>o.value?Array.from(o.value.querySelectorAll(Y)).filter(e=>!e.hasAttribute("disabled")):[],O=()=>{if(!o.value)return null;if(typeof n.initialFocus=="string"&&n.initialFocus){const t=o.value.querySelector(n.initialFocus);if(t)return t}if(typeof n.initialFocus=="function"){const t=n.initialFocus(o.value);if(t)return t}const e=M();return e.length?e[0]:o.value},T=()=>{O()?.focus?.()},C=({source:e="programmatic",emitModelUpdate:t=!1}={})=>{a.value||(b.value=typeof document<"u"?document.activeElement:null,a.value=!0,B(),s("open",{source:e}),t&&s("update:modelValue",!0),k(()=>{T(),s("opened",{source:e})}))},D=({source:e="programmatic",emitModelUpdate:t=!1}={})=>{a.value&&(s("close",{source:e}),a.value=!1,h(),t&&s("update:modelValue",!1),k(()=>{n.restoreFocus&&b.value?.focus?.(),s("closed",{source:e})}))},g=e=>{e==="escape"&&!n.closeOnEscape||e==="backdrop"&&!n.closeOnBackdropClick||(s("cancel",{source:e}),D({source:e,emitModelUpdate:!0}))},S=()=>{g("escape")},E=e=>{e.target===i.value&&g("backdrop")},w=e=>{const t=M();if(!t.length){e.preventDefault(),o.value?.focus?.();return}const F=t[0],x=t[t.length-1],u=typeof document<"u"?document.activeElement:null;if(e.shiftKey){(u===F||u===o.value)&&(e.preventDefault(),x.focus());return}(u===x||u===i.value)&&(e.preventDefault(),F.focus())},j=e=>{if(e.key==="Escape"){e.preventDefault(),g("escape");return}e.key==="Tab"&&n.trapFocus&&w(e)};return N(()=>n.modelValue,e=>{e?C({source:"model"}):D({source:"model"})},{immediate:!0}),V(()=>{a.value&&h()}),(e,t)=>(_(),$(q,null,{default:I(()=>[a.value?(_(),P("dialog",{key:0,ref_key:"dialogEl",ref:i,class:U(["md-modal",{"md-modal--open":a.value}]),open:"",onCancel:R(S,["prevent"]),onClick:E,onKeydown:j},[p("div",{ref_key:"containerEl",ref:o,class:"md-modal__container",tabindex:"-1"},[p("div",Q,[v(e.$slots,"header",{},void 0,!0)]),p("div",W,[v(e.$slots,"default",{},void 0,!0)]),p("div",X,[v(e.$slots,"footer",{},void 0,!0)]),A(L)],512)],34)):K("",!0)]),_:3}))}},y=z(Z,[["__scopeId","data-v-0590d2e9"]]),ge={title:"Components/Dialog",component:y,args:{closeOnEscape:!0,closeOnBackdropClick:!0,trapFocus:!0,restoreFocus:!0,initialFocus:"#dialog-primary-action"},argTypes:{modelValue:{control:!1}}},ee=d=>({components:{MdDialog:y},setup(){return{args:d}},template:`<MdDialog :model-value="true" v-bind="args">
    <template #header>Header</template>
    <div>Lorem ipsum</div>
    <template #footer>Footer</template>
  </MdDialog>`}),te=d=>({components:{MdDialog:y,MdFilledButton:H,MdTextButton:G,MdOutlinedTextField:J},setup(){const c=r(!1),l=r({projectName:"Navigation + Overlay parity",owner:"Design Systems",notes:"Ship MdMenuItem, MdSubMenu, MdTabs, and dialog parity in one release."}),a=()=>{c.value=!0},i=()=>{c.value=!1};return{args:d,form:l,open:c,openDialog:a,closeDialog:i,saveChanges:()=>{i()}}},template:`<div style="padding: 24px; min-height: 420px;">
